...
public class Array_names 
{
  public static void main(String[] args) 
  {
	...
	for (len=0;len < my_list.length;len++)  
	{
		...
		System.out.print(my_list[len] + "+");
	}
	System.out.print("Entered 3 names are: "); //prints message
	
	for (len=0;len < my_list.length;len++) //loop for printing input taken from user && for array 2 loops are used for taking input and printing output for More readable purpose or u can implement in one loop also
	{
